...
import {VideoType} from '../../src/_videos/model/VideoModel';
...
describe('Lesson 1', ()=> {
  describe('/_videos', () => {
    ...
    it('should return 404 for not existing _videos', async () => {
      await request(app)
        .get('/videos/1')
        .expect(404)
    })
    ...
    it('Creatures with valid values and get array with _videos object', async () => {
