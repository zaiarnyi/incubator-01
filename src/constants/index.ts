...
export const NOT_FOUND_BLOG_ID = 'Blog with this id was not found'
export const CONFIRM_CODE_EXPIRED = 'The code lifetime has expired'
export const MAX_LENGTH_VALUE = (number: number): string => `Maximum number of characters ${number}`
