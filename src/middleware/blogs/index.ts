...
export const validationBlogParamSortBy= query('sortBy').trim().optional().isIn(['createdAt', 'id', 'title', 'blogName', 'blogId', 'content', 'name', 'description', 'websiteUrl', 'shortDescription']).withMessage(INVALID_VALUE);
