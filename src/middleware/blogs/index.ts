...
export const validationPostWithBlogIdParamSortBy= query('sortBy').trim().optional().isIn(['title', 'id','name', 'shortDescription', 'content', 'blogId', 'blogName', 'createdAt']).withMessage(INVALID_VALUE);
