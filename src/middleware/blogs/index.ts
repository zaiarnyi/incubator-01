...
export const validationBlogParamSortBy= query('sortBy').trim().optional().isIn(['createdAt', 'id', 'title', 'blogName', 'blogId', 'content', 'name', 'description', 'websiteUrl']).withMessage(INVALID_VALUE);
